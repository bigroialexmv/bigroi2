...
INSERT INTO REVIEW (PRODUCT_CODE, PRODUCT_RATING, REVIEW_CONTENT) VALUES (43, 5, 'Excelent');
INSERT INTO REVIEW (PRODUCT_CODE, PRODUCT_RATING, REVIEW_CONTENT) VALUES (43, 4, 'Not bad');

SELECT P.*, R.AVG_RATING FROM PRODUCT AS P
LEFT JOIN 
	(SELECT AVG(PRODUCT_RATING) AS AVG_RATING, PRODUCT_CODE FROM REVIEW WHERE PRODUCT_CODE=43 GROUP BY PRODUCT_CODE) AS R
	ON P.CODE=R.PRODUCT_CODE 
WHERE CODE=42;

SELECT AVG(PRODUCT_RATING) 
FROM REVIEW WHERE PRODUCT_CODE=43;
